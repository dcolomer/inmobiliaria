 ...
 **/
public class DateChooser extends JDialog implements ItemListener,
		MouseListener, FocusListener, KeyListener, ActionListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = 4965954869861183189L;
	...
	private static class FocusablePanel extends JPanel {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -7622583342266485091L;
